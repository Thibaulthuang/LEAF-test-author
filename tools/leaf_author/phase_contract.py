...
_DEFAULT_MESSAGES = {
    ...
    "provide_system_app_target": "Provide or inspect the installed system-app target before real E2E.",
    "run_real_hypium": "Real-device execution is ready; require explicit user approval before running it.",
    "inspect_system_app_target": "Legacy OpenHarmony project state detected; inspect the system-app target before using this path.",
