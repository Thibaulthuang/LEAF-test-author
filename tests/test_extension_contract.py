...
class ExtensionContractTests(unittest.TestCase):
    def test_camera_extension_contract_summarizes_domain_runtime_and_phase_hooks(self):
        ...
        self.assertEqual(contract["phase_contract"]["target_policy"]["scope"], "system_app_only")
        ...
        self.assertEqual(contract["agent_handoff_contract"]["target_policy"]["scope"], "system_app_only")
