...
class RealDeviceContractTests(unittest.TestCase):
    def test_real_device_gate_contracts_are_stable_for_agents_and_context(self):
        ...
        self.assertEqual(approval["agent_mode"], "orchestrator")
        self.assertEqual(approval["handoff_required"], False)
        self.assertEqual(approval["required_inputs"], ["run_id", "workflow", "decision_contract"])
        self.assertEqual(approval["subagent_boundary"], "workflow_orchestration")
        ...
        self.assertIn("test hap", approval["target_policy"]["forbidden_terms"])
        ...
        self.assertEqual(preflight["agent_mode"], "orchestrator")
        self.assertEqual(preflight["handoff_required"], False)
        self.assertEqual(preflight["required_inputs"], ["run_id", "workflow", "decision_contract"])
        self.assertEqual(preflight["subagent_boundary"], "workflow_orchestration")
        self.assertEqual(preflight["target_policy"]["scope"], "system_app_only")
        self.assertIn("build_app_and_test", preflight["target_policy"]["forbidden_terms"])
